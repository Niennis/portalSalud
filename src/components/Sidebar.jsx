              ...
              <ul>
                ...
                <li className="submenu">
                  ...
                  <ul style={{ display: sidebar === 'Doctors' ? 'block' : 'none' }} className="menu-items1">
                    <li>
                      <Link className={props?.activeClassName === 'doctor-list' ? 'active' : ''} to="/doctorlist">Lista doctores</Link>
                    </li>
                    <li>
                ...
                <li className="submenu">
                  ...
                  <ul style={{ display: "none" }} className="menu-items2">
                    ...
                    <li>
                      <Link className={props?.activeClassName === 'add-patient' ? 'active' : ''} to="/addpatients">Agregar Paciente</Link>
                    </li>
                    {/* <li>
